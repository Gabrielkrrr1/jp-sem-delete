  ...
  <div class="container mt-4">
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="../controller/deletarAgendamento.php" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este agendamento?');" style="display:inline;">
          <input type="hidden" name="id" value="<?= $agend['ID_AGENDAMENTO'] ?>">
